...
class _SoundPlayerState extends State<SoundPlayer> {
  ...
  // In this simple example, we just load a file in memory.This is stupid but just for SoundPlayernstration  of startPlayerFromBuffer()
...
*/
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Flutter Sound SoundPlayer'),
      ),
      body: ListView(
        children: <Widget>[
          recorderSection,
